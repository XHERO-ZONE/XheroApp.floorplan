...
exports.default = function (state, action) {
  switch (action.type) {
    ...
    case _constants.SELECT_TOOL_DRAWING_TEXTURE:
      return _export.Line.selectToolDrawingTexture(state, action.sceneComponentType).updatedState;
    ...
    case _constants.SELECT_LINE_TO_MOVE:
      return _export.Line.selectToMove(state, action.layerID, action.lineID).updatedState;
    case _constants.UNSELECT_LINE:
      console.log(action.layerID, action.lineID);
      return _export.Line.unselect(state, action.layerID, action.lineID).updatedState;
