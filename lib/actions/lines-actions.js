...
exports.selectLineToMove = selectLineToMove;
exports.unSelectLine = unSelectLine;
exports.selectToolDrawingLine = selectToolDrawingLine;
exports.selectToolDrawingTexture = selectToolDrawingTexture;
...
function selectLineToMove(layerID, lineID) {
  return {
    type: _constants.SELECT_LINE_TO_MOVE,
    layerID: layerID,
    lineID: lineID
  };
}

function unSelectLine(layerID, lineID) {
  return {
    type: _constants.UNSELECT_LINE,
    layerID: layerID,
    lineID: lineID
  };
}
...
function selectToolDrawingTexture(sceneComponentType) {
  return {
    type: _constants.SELECT_TOOL_DRAWING_TEXTURE,
    sceneComponentType: sceneComponentType
  };
}
