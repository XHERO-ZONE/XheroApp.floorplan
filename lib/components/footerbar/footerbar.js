  ...
  _createClass(FooterBar, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        this.state.selected === false && mode !== _constants.MODE_IDLE && _react2.default.createElement(
          "div",
          {
            style: {
              display: "flex",
        ...
        this.state.selected && mode === _constants.MODE_IDLE || this.state.isSelectedAll && mode === _constants.MODE_IDLE && _react2.default.createElement(
          "div",
