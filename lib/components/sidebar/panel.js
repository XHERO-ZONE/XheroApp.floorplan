...
var STYLE_TITLE = {
  fontSize: _reactDeviceDetect.isMobile ? "20px" : '18px',
...
var STYLE_CONTENT = {
  fontSize: _reactDeviceDetect.isMobile ? "20px" : '16px',
  color: SharedStyle.PRIMARY_COLOR.text_alt,
...
var PanelWithDevice = function PanelWithDevice(props) {
  ...
  return _react2.default.createElement(Panel, _extends({}, props, { device: device }));
};

exports.default = PanelWithDevice;
