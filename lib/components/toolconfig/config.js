...
var _export3 = require("../../actions/export");
  ...
  _createClass(ToolbarConfig, [{
    ...
    value: function calculateAcreage(layers, scene) {
      ...
      if (selectedLayer.selected.areas.length > 0) {
        var id = selectedLayer.selected.areas[0];
        var area = selectedLayer.areas[id];
        var polygon = area.vertices.map(function (vertexID) {
          var _selectedLayer$vertic = selectedLayer.vertices[vertexID],
        ...
        area.holes.forEach(function (holeID) {
          var polygonHole = selectedLayer.areas[id].holes[holeID].map(function (vertexID) {
        ...
        area.holes.forEach(function (areaID) {
          var hole = selectedLayer.areas[id];
          var holePolygon = hole.vertices.map(function (vertexID) {
            var _selectedLayer$vertic3 = selectedLayer.vertices[vertexID],
                  ...
                  Number(currentFloor) === index ? _react2.default.createElement(
                    "span",
                    {
                      onClick: function onClick() {
                        return _this2.props.updateCurrentFloor(_this2.props.state, index);
                      },
                      style: TextFloor
                    },
                    nameFloor[index]
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(_icons.CloseOutlined, { onClick: this.handleCloseConfig })
              ),
              _react2.default.createElement(
                "div",
                {
                ...
                state.openMaterial ? _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    ...
                    state.showAcreage && selectedArea && _react2.default.createElement(
                      "div",
                      null,
                      _react2.default.createElement(
                        "span",
                    ...
                    _react2.default.createElement(
                      ...
                      selectedArea && _react2.default.createElement(
                        "div",
                        {
