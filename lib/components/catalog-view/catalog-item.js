...
var _STYLE_IMAGE, _STYLE_DESCRIPTION;
...
var STYLE_TITLE = _defineProperty({
  width: "auto",
  textAlign: "center",
  display: "block",
  marginBottom: "0.5em",
...
}, _defineProperty(_STYLE_IMAGE, "backgroundSize", "100% 100%"), _defineProperty(_STYLE_IMAGE, "backgroundColor", SharedStyle.COLORS.white), _defineProperty(_STYLE_IMAGE, "backgroundRepeat", "no-repeat"), _defineProperty(_STYLE_IMAGE, "transition", "all .2s ease-in-out"), _STYLE_IMAGE);
...
var CatalogItem = function (_Component) {
  ...
  _createClass(CatalogItem, [{
    ...
    value: function select() {
      ...
      console.log(this.context.linesActions);
