      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          layers.entrySeq().filter(function (_ref) {
            ...
            return _react2.default.createElement(_export.Layer, { state: state, key: layerID, layer: layer, scene: scene, catalog: catalog });
          })
        ),
        _react2.default.createElement(_export.Layer, { state: state, key: selectedLayer.id, layer: selectedLayer, scene: scene, catalog: catalog })
      );
    }
  }]);
