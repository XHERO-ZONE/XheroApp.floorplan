  ...
  _createClass(ReactPlanner, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_export3.Content, _extends({ width: device.isMobile ? width - toolbarW : contentW, height: contentH, state: extractedState }, props, { onWheel: function onWheel(event) {
            return event.preventDefault();
          } })),
        device.isMobile ? null : _react2.default.createElement(Sidebar, _extends({ width: device.isTablet ? 300 : sidebarW, height: sidebarH, state: extractedState }, props)),
        _react2.default.createElement(FooterBar, _extends({ width: width, height: device.isMobile === true ? 50 : footerBarH, state: extractedState }, props))
      );
    }
  }]);
