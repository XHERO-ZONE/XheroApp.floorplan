  ...
  _createClass(Area, null, [{
    ...
    value: function remove(state, layerID, areaID) {
      ...
      if (area) {
        ...
        state = _export.Layer.removeElement(state, layerID, "areas", areaID).updatedState;
    ...
    key: "beginDraggingArea",
    value: function beginDraggingArea(state, layerID, areaID, x, y) {
    ...
    key: "updateDraggingArea",
    value: function updateDraggingArea(state, x, y) {
      var areaID = state.getIn(["scene", "drawingSupport", "areaID"]);
      var startX = state.getIn(["scene", "drawingSupport", "startX"]);
      var startY = state.getIn(["scene", "drawingSupport", "startY"]);
      ...
      if (areaID) {
        ...
        state = state.updateIn(["scene", "layers", layerID, "areas", areaID, "vertices"], function (vertices) {
          return vertices.map(function (vertexID) {
            var vertex = state.getIn(["scene", "layers", layerID, "vertices", vertexID]);
            return vertex.update("x", function (x) {
              return x + dx;
            }).update("y", function (y) {
              return y + dy;
            });
    ...
    key: "endDraggingArea",
    value: function endDraggingArea(state) {
      // Xóa thông tin kéo
