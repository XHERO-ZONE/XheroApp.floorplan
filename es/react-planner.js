  ...
  _createClass(ReactPlanner, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(Content, _extends({ width: device.isMobile ? width - toolbarW : contentW, height: contentH, state: extractedState }, props, { onWheel: function onWheel(event) {
            return event.preventDefault();
          } })),
        device.isMobile ? null : React.createElement(Sidebar, _extends({ width: device.isTablet ? 300 : sidebarW, height: sidebarH, state: extractedState }, props)),
